...
app = Flask(__name__, template_folder=r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\templates', 
            static_folder=r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\static')
app.secret_key = "supersecretkey"

# Define paths and file locations
models_dir = r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\models'
model_paths = {
...
val_hog_features = pickle.load(open('C:/Users/Nimisha/Desktop/Skin-disease-detection-using-Machine-Learning-with-ensemble-methods/features/val_hog_features.pkl', 'rb'))

# Use feature selector from models directory
...
def predict():
    ...
    if file and allowed_file(file.filename):
        ...
        file_path = os.path.join(r'C:\Users\Nimisha\Desktop\s_detect\uploads', filename)
        ...
        try:
            ...
            file_path = os.path.join(r'C:\Users\Nimisha\Desktop\s_detect\uploads', 'captured_image.png')
...
def uploaded_file(filename):
    return send_from_directory(r'C:\Users\Nimisha\Desktop\s_detect\uploads', filename)

# Ensure uploads directory exists
if __name__ == '__main__':
    os.makedirs(r'C:\Users\Nimisha\Desktop\s_detect\uploads', exist_ok=True)
