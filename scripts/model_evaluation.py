...
model_paths = {
    'bagging': r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\models\bagging_model.pkl',
    'adaboost': r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\models\adaboost_model.pkl',
    'hist_gradient_boosting': r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\models\hist_gradient_boosting_model.pkl',
    'extra_trees': r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\models\extra_trees_model.pkl'
}

# Define paths for validation features and labels (corrected locations)
val_features_path = r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\detect_skin\val_hog_features.pkl'
val_labels_path = r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\detect_skin\val_labels.npy'

# Define path for feature selector and label encoder
selector_path = r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\models\feature_selector.pkl'
label_encoder_path = r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\models\label_encoder.pkl'
...
train_labels = np.load(r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\detect_skin\train_labels.npy')
val_labels = np.load(r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\detect_skin\val_labels.npy')

# Load the HOG features
train_hog_features = load_hog_features(r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\features\train_hog_features.pkl')
val_hog_features = load_hog_features(r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\features\val_hog_features.pkl')
...
# Load the training and validation data
train_labels = np.load('C:/Users/Nimisha/Desktop/Skin-disease-detection-using-Machine-Learning-with-ensemble-methods/features/train_labels.npy')
val_labels = np.load('C:/Users/Nimisha/Desktop/Skin-disease-detection-using-Machine-Learning-with-ensemble-methods/features/val_labels.npy')

train_hog_features = load_hog_features('C:/Users/Nimisha/Desktop/Skin-disease-detection-using-Machine-Learning-with-ensemble-methods/features/train_hog_features.pkl')
val_hog_features = load_hog_features('C:/Users/Nimisha/Desktop/Skin-disease-detection-using-Machine-Learning-with-ensemble-methods/features/val_hog_features.pkl')
...
#
# Define paths
val_labels_path = 'C:/Users/Nimisha/Desktop/Skin-disease-detection-using-Machine-Learning-with-ensemble-methods/features/val_labels.npy'
val_hog_features_path = 'C:/Users/Nimisha/Desktop/Skin-disease-detection-using-Machine-Learning-with-ensemble-methods/features/val_hog_features.pkl'
models_dir = 'C:/Users/Nimisha/Desktop/Skin-disease-detection-using-Machine-Learning-with-ensemble-methods/models'
