...
train_features_path = r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\features\train_hog_features.pkl'  # Path to training HOG features
train_labels_path = r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\features\train_labels.npy'  # Path to training labels
models_dir = r'C:\Users\Nimisha\Desktop\Skin-disease-detection-using-Machine-Learning-with-ensemble-methods\models'  # Directory where the trained models will be saved
